...
class OtpForgotPasswordPage extends StatefulWidget {
  @override
  _OtpForgotPasswordPageState createState() => _OtpForgotPasswordPageState();
}

class _OtpForgotPasswordPageState extends StateMVC<OtpForgotPasswordPage> {
  UserController _con;

  _OtpForgotPasswordPageState() : super(UserController()) {
    _con = controller;
  }
  @override
